...
// Constants header
	...
	#define VERSION_NAME												"2018r1 (ShangDi)"
...
//	#define	WORD_PARAMETER_CONJUNCTION_THAN											1003
	...
	// Listing (conflicts)
	#define	INTERFACE_LISTING_SENTENCE_IN_CONFLICT_WITH_ITSELF										1300
	#define	INTERFACE_LISTING_QUESTION_IN_CONFLICT_WITH_ITSELF										1301
	#define	INTERFACE_LISTING_CONFLICT																1302
	#define	INTERFACE_LISTING_SENTENCE_DOESNT_LEAVE_ANY_OPTION_OPEN									1303
	#define	INTERFACE_LISTING_SENTENCE_DEFINITION_SPECIFICATION_IS_ALREADY_ASSIGNED					1304
	#define	INTERFACE_LISTING_SENTENCE_ASSIGNMENT_IN_CONFLICT_WITH_DEFINITION_SPECIFICATION			1305
