...
// Constants header
	...
	#define VERSION_NAME												"2024 (Intelligent Origin)"
	...
	#define	ASSUMPTION_LEVEL_PROBABLY									1
	#define	ASSUMPTION_LEVEL_POSSIBLY									2
	#define	ASSUMPTION_LEVEL_MAYBE										3
...
//#endif
	...
	#define	JUSTIFICATION_TYPE_OPPOSITE_POSSESSIVE_SPECIFICATION_ASSUMPTION							1
	#define	JUSTIFICATION_TYPE_EXCLUSIVE_SPECIFICATION_SUBSTITUTION_ASSUMPTION						2
	#define	JUSTIFICATION_TYPE_SUGGESTIVE_QUESTION_ASSUMPTION										3

	#define	JUSTIFICATION_TYPE_ONLY_OPTION_LEFT_ASSUMPTION_OR_CONCLUSION							4
	#define	JUSTIFICATION_TYPE_REVERSIBLE_ASSUMPTION_OR_CONCLUSION									5
	#define	JUSTIFICATION_TYPE_DEFINITION_PART_OF_ASSUMPTION_OR_CONCLUSION							6
	#define	JUSTIFICATION_TYPE_NEGATIVE_ASSUMPTION_OR_CONCLUSION									7
	#define	JUSTIFICATION_TYPE_SPECIFICATION_GENERALIZATION_SUBSTITUTION_ASSUMPTION_OR_CONCLUSION	8
	#define	JUSTIFICATION_TYPE_SPECIFICATION_SUBSTITUTION_ASSUMPTION_OR_CONCLUSION					9
	#define	JUSTIFICATION_TYPE_SPECIFICATION_SUBSTITUTION_PART_OF_ASSUMPTION_OR_CONCLUSION			10
	#define	JUSTIFICATION_TYPE_UNIQUE_RELATION_ASSUMPTION_OR_CONCLUSION								11

	#define	JUSTIFICATION_TYPE_SPECIFICATION_SUBSTITUTION_QUESTION									12
...
//	#define	WORD_PARAMETER_ADJECTIVE_NEXT_FEMININE_MASCULINE						632
	...
	#define	WORD_PARAMETER_ADJECTIVE_CHINESE_HIGH									639
	#define	WORD_PARAMETER_ADJECTIVE_CHINESE_LOW									640
...
//	#define	WORD_PARAMETER_CONJUNCTION_THAN											1003
	...
	#define	INTERFACE_LISTING_MY_ASSUMPTIONS_THAT_HAVE_BEEN_ADJUSTED								1315
	#define	INTERFACE_LISTING_MY_ASSUMPTIONS_THAT_HAVE_BEEN_CONCLUDED								1316
	#define	INTERFACE_LISTING_MY_CONCLUSIONS_THAT_ARE_NOT_HIDDEN_ANYMORE							1317
	#define	INTERFACE_LISTING_MY_ASSUMPTIONS_THAT_ARE_NOT_HIDDEN_ANYMORE							1318
	#define	INTERFACE_LISTING_MY_QUESTIONS															1319
	#define	INTERFACE_LISTING_MY_ADJUSTED_QUESTIONS													1320
	#define	INTERFACE_LISTING_MY_ANSWER																1321
	#define	INTERFACE_LISTING_I_ONLY_KNOW															1322
	#define	INTERFACE_LISTING_SPECIFICATIONS														1323
	#define	INTERFACE_LISTING_RELATED_INFORMATION													1324
	#define	INTERFACE_LISTING_RELATED_QUESTIONS														1325

	// Listing (old information)
	#define	INTERFACE_LISTING_CONFIRMED_SPECIFICATION_OF_MY_ASSUMPTION_BUT_NONE_OF_ITS_RELATIONS	1330
	#define	INTERFACE_LISTING_CONFIRMED_SPECIFICATION_OF_MY_CONCLUSION_BUT_NONE_OF_ITS_RELATIONS	1331
	...
	#define	INTERFACE_LISTING_MY_ASSUMPTIONS_THAT_HAVE_BEEN_CONFIRMED								1334
	#define	INTERFACE_LISTING_MY_CONCLUSIONS_THAT_HAVE_BEEN_CONFIRMED								1335
	...
	#define	INTERFACE_LISTING_YOUR_QUESTIONS_THAT_HAVE_BEEN_ANSWERED								1343
	#define	INTERFACE_LISTING_MY_QUESTIONS_THAT_HAVE_BEEN_ANSWERED									1344
	...
	#define	INTERFACE_SENTENCE_ERROR_GRAMMAR_INTEGRITY_SENTENCE_START								1641
	#define	INTERFACE_SENTENCE_ERROR_GRAMMAR_INTEGRITY_SENTENCE_DUE_TO_WORDS						1642
	#define	INTERFACE_SENTENCE_ERROR_GRAMMAR_INTEGRITY_I_RETRIEVED_FROM_MY_SYSTEM_START				1643
	#define	INTERFACE_SENTENCE_ERROR_GRAMMAR_INTEGRITY_I_RETRIEVED_FROM_MY_SYSTEM_END				1644
