...
//	#define PRESENTATION_PROMPT_ENTER							7
	...
	#define	WORD_INTERFACE_LANGUAGE_LIST						3
	#define	WORD_JUSTIFICATION_LIST								4
	#define	WORD_GRAMMAR_LANGUAGE_LIST							5
	...
	#define	WORD_INTERFACE_LANGUAGE_LIST_SYMBOL					'i'
	#define	WORD_JUSTIFICATION_LIST_SYMBOL						'j'
	#define	WORD_GRAMMAR_LANGUAGE_LIST_SYMBOL					'l'
	...
	#define NUMBER_OF_ASSUMPTION_LEVELS							3		// Probably, possibly and may be
	...
	#define	WORD_PARAMETER_ADJECTIVE_CALLED_SINGULAR								611
	#define	WORD_PARAMETER_ADJECTIVE_EVERY_NEUTRAL									612
	#define	WORD_PARAMETER_ADJECTIVE_EVERY_FEMININE_MASCULINE						613
	#define	WORD_PARAMETER_ADJECTIVE_PREVIOUS_NEUTRAL								614
	#define	WORD_PARAMETER_ADJECTIVE_PREVIOUS_FEMININE_MASCULINE					615
	#define	WORD_PARAMETER_ADJECTIVE_CURRENT_NEUTRAL								616
	#define	WORD_PARAMETER_ADJECTIVE_CURRENT_FEMININE_MASCULINE						617
	#define	WORD_PARAMETER_ADJECTIVE_NEW_NEUTRAL									618
	#define	WORD_PARAMETER_ADJECTIVE_NEW_FEMININE_MASCULINE							619
//	#define	WORD_PARAMETER_ADJECTIVE_NEXT_NEUTRAL									620
//	#define	WORD_PARAMETER_ADJECTIVE_NEXT_FEMININE_MASCULINE						621
	#define	WORD_PARAMETER_ADJECTIVE_ODD											622
	#define	WORD_PARAMETER_ADJECTIVE_EVEN											623
	#define	WORD_PARAMETER_ADJECTIVE_EARLIER										624
	#define	WORD_PARAMETER_ADJECTIVE_LESS											625
	#define	WORD_PARAMETER_ADJECTIVE_LOWER											626
	#define	WORD_PARAMETER_ADJECTIVE_SMALLER										627
	#define	WORD_PARAMETER_ADJECTIVE_EQUAL											628
	#define	WORD_PARAMETER_ADJECTIVE_SAME											629
	#define	WORD_PARAMETER_ADJECTIVE_BIGGER											630
	#define	WORD_PARAMETER_ADJECTIVE_HIGHER											631
	#define	WORD_PARAMETER_ADJECTIVE_LARGER											632
	#define	WORD_PARAMETER_ADJECTIVE_LATER											633
	#define	WORD_PARAMETER_ADJECTIVE_MORE											634

	// Adverbs
	#define	WORD_PARAMETER_ADVERB_ANYMORE											700
	#define	WORD_PARAMETER_ADVERB_AS												701
	#define	WORD_PARAMETER_ADVERB_ASSUMPTION_MAY_BE									702
	...
	#define	WORD_PARAMETER_NOUN_GRAMMAR_LANGUAGE									1103
	#define	WORD_PARAMETER_NOUN_INTERFACE_LANGUAGE									1104
	#define	WORD_PARAMETER_NOUN_JUSTIFICATION_REPORT								1105
	#define	WORD_PARAMETER_NOUN_HEAD												1106
	#define	WORD_PARAMETER_NOUN_TAIL												1107
	#define	WORD_PARAMETER_NOUN_MIND												1108
	#define	WORD_PARAMETER_NOUN_NUMBER												1109
	#define	WORD_PARAMETER_NOUN_PASSWORD											1110
	#define	WORD_PARAMETER_NOUN_SOLVE_LEVEL											1111
	#define	WORD_PARAMETER_NOUN_SOLVE_METHOD										1112
	#define	WORD_PARAMETER_NOUN_SOLVE_STRATEGY										1113
	...
	#define	WORD_PARAMETER_PREPOSITION_FOR											2101
	#define	WORD_PARAMETER_PREPOSITION_FROM											2102
	#define	WORD_PARAMETER_PREPOSITION_IN											2103
	#define	WORD_PARAMETER_PREPOSITION_TO											2104
	...
	#define	NO_GRAMMAR_NAME_FOUND_STRING															"{no grammar name found}"
	...
	#define	NO_INTERFACE_LANGUAGE_AVAILABLE															"<no interface language available>"

	// Console (common)
	#define	INTERFACE_CONSOLE_START_MESSAGE															100
//	#define	INTERFACE_CONSOLE_LOGIN_WELCOME															106
	#define	INTERFACE_CONSOLE_ALREADY_LOGGED_IN_START												107
	#define	INTERFACE_CONSOLE_LOGIN_END																108
	#define	INTERFACE_CONSOLE_LOGIN_FAILED															109
...
//	#define	INTERFACE_CONSOLE_I_AM_CLEANING_UP_DELETED_ITEMS										112
	...
	#define	INTERFACE_IMPERATIVE_NOTIFICATION_UNDO_SENTENCE_OF_ANOTHER_USER							1201
	#define	INTERFACE_IMPERATIVE_NOTIFICATION_NO_SENTENCES_LEFT_TO_UNDO								1202
	#define	INTERFACE_IMPERATIVE_NOTIFICATION_NO_SENTENCES_TO_REDO									1203
	#define	INTERFACE_IMPERATIVE_NOTIFICATION_I_HAVE_UNDONE_SENTENCE_NR_START						1204
	#define	INTERFACE_IMPERATIVE_NOTIFICATION_I_HAVE_UNDONE_SENTENCE_NR_END							1205
	#define	INTERFACE_IMPERATIVE_NOTIFICATION_I_HAVE_REDONE_SENTENCE_NR_START						1206
	#define	INTERFACE_IMPERATIVE_NOTIFICATION_I_HAVE_REDONE_SENTENCE_NR_END							1207
	#define	INTERFACE_IMPERATIVE_NOTIFICATION_I_HAVE_NO												1208

	// Imperative (warnings)
	#define	INTERFACE_IMPERATIVE_WARNING_I_DONT_HAVE_ANY_INFO_ABOUT_START							1210
	#define	INTERFACE_IMPERATIVE_WARNING_I_DONT_HAVE_ANY_INFO_ABOUT_END								1211
	...
	#define	INTERFACE_IMPERATIVE_WARNING_I_COULD_FIND_SOLVE_INFO_START								1216
	#define	INTERFACE_IMPERATIVE_WARNING_I_COULD_FIND_SOLVE_INFO_END								1217
	...
	#define	INTERFACE_LISTING_MY_QUESTIONS															1417
	#define	INTERFACE_LISTING_MY_ADJUSTED_QUESTIONS													1418
	#define	INTERFACE_LISTING_MY_ANSWER																1419
	#define	INTERFACE_LISTING_I_ONLY_KNOW															1420
	#define	INTERFACE_LISTING_I_AM_NOT_SURE_BUT														1421
	#define	INTERFACE_LISTING_SPECIFICATIONS														1422
	#define	INTERFACE_LISTING_SPECIFICATION_QUESTIONS												1423
	#define	INTERFACE_LISTING_RELATED_INFORMATION													1424
	#define	INTERFACE_LISTING_RELATED_QUESTIONS														1425
