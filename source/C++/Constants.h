...
// Constants header
	...
	#define VERSION_NAME												"2023 (Shaking tree)"
...
//#endif
	...
	#define	JUSTIFICATION_TYPE_ONLY_OPTION_LEFT_ASSUMPTION_OR_CONCLUSION							5
	#define	JUSTIFICATION_TYPE_REVERSIBLE_ASSUMPTION_OR_CONCLUSION									6
	#define	JUSTIFICATION_TYPE_DEFINITION_PART_OF_ASSUMPTION_OR_CONCLUSION							7
	#define	JUSTIFICATION_TYPE_NEGATIVE_ASSUMPTION_OR_CONCLUSION									8
	#define	JUSTIFICATION_TYPE_SPECIFICATION_GENERALIZATION_SUBSTITUTION_ASSUMPTION_OR_CONCLUSION	9
	#define	JUSTIFICATION_TYPE_SPECIFICATION_SUBSTITUTION_ASSUMPTION_OR_CONCLUSION					10
	#define	JUSTIFICATION_TYPE_SPECIFICATION_SUBSTITUTION_PART_OF_ASSUMPTION_OR_CONCLUSION			11
	#define	JUSTIFICATION_TYPE_UNIQUE_RELATION_ASSUMPTION_OR_CONCLUSION								12

	#define	JUSTIFICATION_TYPE_SPECIFICATION_SUBSTITUTION_QUESTION									13
