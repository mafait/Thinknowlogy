...
// Constants header
	...
	#define VERSION_NAME												"2016r2 (Restyle)"
	...
	#define PRESENTATION_PROMPT_WARNING_INDENTED						6
	#define PRESENTATION_PROMPT_QUERY									7
	...
	#define MAX_ASSUMPTION_LEVEL_RECALCULATIONS							250		// Maximum number of repeated calculations
	#define MAX_GRAMMAR_LEVEL											50		// Maximum depth of grammar parsing
	#define MAX_SELECTION_EXECUTIONS									250		// Maximum number of repeated selections
...
//	#define	WORD_PARAMETER_CONJUNCTION_FRENCH_THAN									1003
	...
	#define	WORD_PARAMETER_SINGULAR_VERB_IMPERATIVE_MOVE							2208
	#define	WORD_PARAMETER_SINGULAR_VERB_IMPERATIVE_REMOVE							2209
	#define	WORD_PARAMETER_SINGULAR_VERB_IMPERATIVE_CLEAR							2210
	#define	WORD_PARAMETER_SINGULAR_VERB_IMPERATIVE_HELP							2211
	#define	WORD_PARAMETER_SINGULAR_VERB_IMPERATIVE_LOGIN							2212
	#define	WORD_PARAMETER_SINGULAR_VERB_IMPERATIVE_READ							2213
	#define	WORD_PARAMETER_SINGULAR_VERB_IMPERATIVE_REDO							2214
	#define	WORD_PARAMETER_SINGULAR_VERB_IMPERATIVE_RESTART							2215
	...
	// Console (common)
	#define	INTERFACE_CONSOLE_INITIAL_MESSAGE														100
	#define	INTERFACE_CONSOLE_ALREADY_LOGGED_IN_START												105
	#define	INTERFACE_CONSOLE_LOGIN_END																106
	#define	INTERFACE_CONSOLE_LOGIN_FAILED															107
	...
	#define	INTERFACE_LISTING_MY_EARLIER_ASSUMPTIONS_THAT_HAVE_RELATION_WORDS_NOW					1436
	#define	INTERFACE_LISTING_MY_EARLIER_CONCLUSIONS_THAT_HAVE_RELATION_WORDS_NOW					1437
	#define	INTERFACE_LISTING_YOUR_INFO_IS_MORE_SPECIFIC_THAN_MY_ASSUMPTION							1438
	#define	INTERFACE_LISTING_YOUR_INFO_IS_MORE_SPECIFIC_THAN_MY_CONCLUSION							1439
	#define	INTERFACE_LISTING_YOUR_QUESTION_IS_MORE_SPECIFIC_THAN_MY_QUESTION						1440
	#define	INTERFACE_LISTING_THIS_INFO_IS_MORE_SPECIFIC_THAN_YOUR_EARLIER_INFO						1441
	#define	INTERFACE_LISTING_THIS_QUESTION_IS_MORE_SPECIFIC_THAN_YOUR_QUESTION						1442
	#define	INTERFACE_LISTING_YOUR_QUESTIONS_THAT_ARE_ANSWERED										1443
	#define	INTERFACE_LISTING_MY_QUESTIONS_THAT_ARE_ANSWERED										1444
	#define	INTERFACE_LISTING_MY_CORRECTED_ASSUMPTIONS_BY_KNOWLEDGE									1445
	#define	INTERFACE_LISTING_MY_CORRECTED_ASSUMPTIONS_BY_OPPOSITE_QUESTION							1446
	...
	#define	INTERFACE_SENTENCE_WARNING_WORD_IS_GENERALIZATION_AS_WELL_AS_RELATION_START				1627
	#define	INTERFACE_SENTENCE_WARNING_WORD_IS_GENERALIZATION_AS_WELL_AS_RELATION_END				1628
	#define	INTERFACE_SENTENCE_WARNING_NOT_ABLE_TO_LINK_YES_NO_TO_QUESTION							1629
	#define	INTERFACE_SENTENCE_WARNING_AMBIGUOUS_SENTENCE_MISSING_RELATION							1630
	#define	INTERFACE_SENTENCE_WARNING_AMBIGUOUS_SENTENCE_MULTIPLE_SPECIFICATIONS_RELATIONS			1631
