				...
				if( ( currentGeneralizationWordItem = CommonVariables.firstWordItem ) != null )
					...
					do	{
						...
						currentGeneralizationWordItem.hasWordType( generalizationWordTypeNr ) )
							...
							if( ( foundSpecificationItem = currentGeneralizationWordItem.firstAssignmentOrSpecificationItem( true, false, false, isPossessive, Constants.NO_QUESTION_PARAMETER, generalizationContextNr, specificationContextNr, relationContextNr, specificationWordItem ) ) != null )
								{
